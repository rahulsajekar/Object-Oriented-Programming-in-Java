...
//		
//		fill(0, 0, 0);
//		text("5.0+ Magnitude", 75, 325);
//		text("4.0+ Magnitude", 75, 375);
//		text("Below 4.0", 75, 325);
		noFill();
		rect(20,400,150,220);
		fill(0);
		text("Earthquake Key",40,425);
		
		fill(255,0,0);
		triangle(40,455,46,445,52,455);
		fill(255,255,255);
		ellipse(45,470,9,9);
		rect(40,490,9,9);
		fill(250,250,0);
		...
		fill(0);
		text("City Marker",60,460);
		text("Land Quake",60,480);
		text("Ocean Quake",60,500);
		text("Size ~ Magnitude",40,520);
		text("Shallow",60,555);
		text("Intermediate",60,575);
		text("Deep",60,595);
	...
	private void printQuakes() 
	{
		...
		for(Marker cm : countryMarkers)
		{
			...
			{
				if(qm.getProperty("country")== cm.getProperty("name"))
				{
					count++;
				}
			}
